function  auc = plot_roc_PTBM2(T_train,T_sim)  
% INPUTS  
...
legend('Logistic(AUC=0.7335)','SVM(AUC=0.7803)','BP(AUC=0.8361)','Bagging(AUC=0.8633)','ECBAM(AUC=0.8997)','AUC=0.5','FontSize',18,'Fontname','Times','location','SouthEast')
legend boxoff
end  